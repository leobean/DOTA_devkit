...
if __name__ == '__main__':
    ...
    parser.add_argument('--dota_format', help='dota format folder, img/txt')
    parser.add_argument('--coco_format', help='coco format json')
    args = parser.parse_args()
    DOTA2COCO(args.dota_format, args.coco_format)
