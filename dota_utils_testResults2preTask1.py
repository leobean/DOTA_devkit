    ...
    while True:
        ...
        if line:
            ...
            if (len(splitlines) < 9):
                continue
            if (len(splitlines) >= 9):
                object_struct['name'] = splitlines[9]
                object_struct['confidence'] = splitlines[8]
            #if (len(splitlines) == 9):
...
def groundtruth2Task1(srcpath, dstpath):
    ...
    for filepath in filelist:
        ...
        for obj in objects:
            ...
            poly = obj['poly']
            outline = custombasename(filepath) + ' ' + confidence + ' ' + ' '.join(map(str, poly))
...
if __name__ == '__main__':
    groundtruth2Task1('/home/konglingbin/project/dota/Faster_RCNN_for_DOTA/output/rcnn/DOTA_quadrangle/DOTA_quadrangle/test/test_results', '/home/konglingbin/project/dota/Faster_RCNN_for_DOTA/output/rcnn/DOTA_quadrangle/DOTA_quadrangle/test/test_results_premerge')